...
using CoreCommon.Application.Base.Base;
...
namespace CoreCommon.Application.WebBase.Base
{
    /// <summary>
    /// <inheritdoc />.
    /// </summary>
        ...
        public virtual void Configure(IApplicationBuilder app, IHostEnvironment env)
        {
            ...
            /*app.UseExceptionHandler(errorApp =>
            {
                errorApp.Run(async context =>
                {
                    ...
                    {
                        response = ServiceResult<string>.Instance.ErrorResult(ServiceResultCode.ServerError, "An error occured");
